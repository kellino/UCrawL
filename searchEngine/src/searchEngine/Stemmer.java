...
import TerrierStemmer.PorterStemmer;

////////////////////////////
// Uses the porter stemmer copied directly from Terrier


/**
 * Stemmer which removes all stopwords
 * and uses the terrier porter stemmer 
 * 
 * @author jncys
 *
 */
public class Stemmer {
	...
	private static String[] stopword = {"ucl", "a", "about", "above", "above", "across", "after"
	...
	private static HashSet<String> stopwords = new HashSet<String>(Arrays.asList(stopword));
